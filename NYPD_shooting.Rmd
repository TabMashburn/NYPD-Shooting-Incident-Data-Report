...
```{r import data, message=FALSE, warning=FALSE,  cache=TRUE}
library(tidyverse)
...
data %>%
  ...
  ggtitle("NYC Shooting Incidents Numbers (2006-2010)") +
...
NYC_median_income <- read_csv("./data/NYC_median_income.csv")
